...
- **Panels** — 2-up grid of insertable parts: Shelf, Side Panel, Back Panel, Divider. **Fronts** — solid Door plus AXSTAD-style glass doors (400/600 × 800/1000, 19 mm, 78 mm shaker frame). **Hardware** — Knob, BAGGANÄS, ENERYDA bow pull, BORGHAMN square bar (170 mm), ENHET leg.
