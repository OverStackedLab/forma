...
| IMP-009 | Front, top and side camera views while modelling | Front / Side / Top switch to a locked orthographic camera (true elevation/plan, no foreshortening). ¾ Angle and Frame stay perspective. Left-drag pans in ortho; orbit is disabled so the view cannot tilt. Covered by ortho-frustum unit tests and model/render browser checks. | 2026-08-20 |
