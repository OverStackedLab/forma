...
| IMP-019 | Traditional framed cabinet doors | BODBYN off-white fronts (IKEA range): 70 mm stiles, 19 mm thick. Solid doors and drawer fronts with a bevelled rebate and recessed panel; one glass door (40×40 with a + cross-rail). Door, drawer and that glass size from the törtfehér előlapok category, including the 45×80 dishwasher front (IKEA 802.915.52). Frame width stays 70 mm when the door is resized. Covered by `bodbynPieces` / `bodbynGlassPieces` unit tests and Library insert browser checks. | 2026-09-02 |
| IMP-020 | Measure in straight lines | Second click locks to a world axis with Shift; Front/Side/Top measure in the view plane; object snap catches vertices and edges. Rubber-band preview plus ΔX/ΔY/ΔZ on diagonals. Covered by `measure.ts` unit tests. | 2026-09-11 |
| IMP-021 | Drawer boxes | Four-piece generated drawer groups (18 mm sides, 8 mm bottom and back), sibling to cabinets, no decorative front. Presets match BODBYN drawer-front widths. Covered by `buildDrawerLayout` / insert unit tests and a Library insert browser check. | 2026-09-11 |
| IMP-022 | Resize the Assembly / Library panel | Drag the left sidebar's right edge (200–480 px). Double-click resets to 240 px. Width is a chrome preference, not document data. Covered by `sidebarWidth` unit tests and a drag + reload browser check. | 2026-09-12 |
