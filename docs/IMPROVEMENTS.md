...
| IMP-010 | See the distance between two panels without freehand measure | Selecting exactly two pieces or groups draws SketchUp-style witnesses and a length label on each axis with a positive AABB clearance. Covered by `selectionGap` unit tests and a two-shelf browser check. | 2026-08-22 |
